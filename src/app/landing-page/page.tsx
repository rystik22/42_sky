          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative z-20">
              ...
              <h1 className="text-5xl md:text-7xl font-light tracking-tight mb-8">
                Where <span className="font-normal bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">ideas</span> meet <span className="font-normal bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent">community</span>
              </h1>
              
              <p className="text-lg text-gray-400 mb-10 max-w-lg">
                Discover unique events curated for the 42 Abu Dhabi community. Connect, learn, and grow with fellow innovators.
              </p>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4">
          <div className="flex justify-between items-center mb-16">
            <div>
              ...
              <h2 className="text-3xl font-light">Featured <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">experiences</span></h2>
            </div>
          ...
          {/* Alternative event display for mobile */}
          <div className="block md:hidden space-y-4">
            ...
            <div className="text-center mt-6">
              <button className="text-sm text-white/70 hover:text-white flex items-center mx-auto">
                See more events <ChevronRight className="h-4 w-4 ml-1" />
              </button>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 relative overflow-hidden bg-gray-900">
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          <div className="mb-16">
            ...
            <h2 className="text-3xl font-light">Find your <span className="bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent">community</span></h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { name: "Workshops", description: "Hands-on learning experiences", color: "from-blue-600/20 to-blue-800/20", icon: "💻" },
              { name: "Competitions", description: "Test your skills and win prizes", color: "from-indigo-600/20 to-indigo-800/20", icon: "🏆" },
              { name: "Social", description: "Connect with the community", color: "from-emerald-600/20 to-emerald-800/20", icon: "🎉" },
              { name: "Lectures", description: "Learn from industry experts", color: "from-amber-600/20 to-amber-800/20", icon: "🎓" }
            ].map((category) => (
              <div 
                key={category.name} 
              ...
              >
                <div className={`absolute -bottom-8 -right-8 w-32 h-32 rounded-full bg-gradient-to-br ${category.color} blur-xl opacity-70 group-hover:opacity-100 transition-opacity`}></div>
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 md:p-12">
            <div className="max-w-2xl mx-auto text-center">
              <h2 className="text-3xl font-light mb-4">Stay <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">informed</span></h2>
              <p className="text-white/70 mb-8">Get updates on the latest events and opportunities from the 42 Abu Dhabi community.</p>
